...
\end{itemize}
The efficiency of a hybrid quantum-classical experiment is then characterized by the sum of these variables:
\begin{equation}
...
\begin{sidewaystable}
    ...
    {\renewcommand{\arraystretch}{1.15}
        ...
        \begin{tabular}{cccccccccccccc}
            ...
            $33$ & $200$ & $6307.4$s & $3394.2$s & $2206.7$s & $1770.6$s & $1506.3$s & $1198.8$s & $1090.5$s & $1030.3$s & $1114.8$s & $898.1$s & $883.2$s & \underline{$\mathbf{837.0}$\textbf{s}} \\
            $34$ & $206$ & $14827.4$s & $7855.2$s & $4996.7$s & $3853.7$s & $2971.9$s & $2325.1$s & $2066.3$s & $1798.9$s & $2043.4$s & $1498.6$s & $1454.3$s & \underline{$\mathbf{1390.7}$\textbf{s}} \\
            $35$ & $212$ & $37658.7$s & $20438.4$s & $12516.8$s & $9242.1$s & $6645.5$s & $4926.8$s & $4034.7$s & $3424.5$s & $4063.6$s & $2936.7$s & $2769.5$s & \underline{$\mathbf{2679.0}$\textbf{s}} \\
        \end{tabular}
    }
