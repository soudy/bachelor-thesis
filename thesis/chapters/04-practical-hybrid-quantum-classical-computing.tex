...
The benchmark results are displayed in \Cref{table:qx_benchmark}.
...
% default is (1.5TB)*n/40
\subsection{Development Cycle}
% simulation and qpu back-ends are in the cloud, network overhead, local simulation

% sum up speedups and factor relative to table 4.3 measurements
