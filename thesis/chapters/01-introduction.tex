...
Research towards \glspl{hqca} often involves executing quantum circuits on actual \glspl{qpu} or through quantum circuit simulation.
...
\section{Objective}
The purpose of this thesis is to propose and analyze different workflows for the efficient execution of \acrlongpl{hqca}.
...
\Cref{chap:practical-hybrid-quantum-classical-computing} demonstrates the practical execution of \glspl{hqca} using Quantum Inspire's quantum computing platform and SURF's \gls{hpc} center and analyzes the efficiency of different hybrid quantum-classical workflows.
