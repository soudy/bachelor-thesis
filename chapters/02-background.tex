...
The amount of probability amplitudes grows exponentially with the number of qubits.
...
If one has the circuit to prepare \ket{\psi}, you could simply create \ket{\psi}\ket{\psi} by duplicating the circuit on a second qubit.
