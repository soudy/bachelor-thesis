...
\begin{equation}
\begin{aligned}
\langle O \rangle_\psi &= \bra{\psi}O\ket{\psi} \\
...
Two quantum algorithms which provide a speedup over their classical counterparts are now reviewed: the quantum Fourier transforms and Grover's algorithm.
...
On the other hand, the \gls{qft} is the backbone of the phase estimation algorithm, which in term can be used to solve problems including the order-finding problem and the factoring problem.
